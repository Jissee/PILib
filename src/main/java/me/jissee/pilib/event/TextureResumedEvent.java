 ...
 * This event is fired when the texture of the entity is resumed.
 * This event is not cancellable.
 * This event is posted on {@link MinecraftForge#EVENT_BUS}.
 */
public class TextureResumedEvent extends Event {
    private final Texture2DManager manager;
    private final int texturePtr;
    private final int progress;
    public TextureResumedEvent(Texture2DManager manager, int texturePtr, int progress){
