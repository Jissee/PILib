...
public class TestEntity extends Mob implements Renderable2D {
    ...
    public Animation2D prepareAnimation2(){
        Animation2D anim = new Animation2D(-1,(long) 1e9, RenderSetting.PERPENDICULAR_DOUBLE);
        anim.addTexture(new ResourceLocation(MODID,"textures/entity/testentity.png"), new ResourceLocation(MODID,"textures/entity/testentitythin.png"));
        anim.addTexture(new ResourceLocation(MODID,"textures/entity/transparent.png"), new ResourceLocation(MODID,"textures/entity/testentitythin.png"));
        return anim;
    }

    public Animation2D prepareAnimation3(){
        Animation2D anim = new Animation2D(-1,41666666L, RenderSetting.PERPENDICULAR_SINGLE);
        anim.addTexture(new ResourceLocation(MODID,"textures/entity/testentity.png"));
        anim.addTexture(new ResourceLocation(MODID,"textures/entity/transparent.png"));
        anim.addTexture(new ResourceLocation(MODID,"textures/entity/testentitythin.png"));
        return anim;
    ...
    public VideoResource prepareVideo5(){
         return new VideoResource(new File(ResourceUtil.getFileName(MODID, 0)), "", 25,true, RenderSetting.PERPENDICULAR_DOUBLE);
    }
}
