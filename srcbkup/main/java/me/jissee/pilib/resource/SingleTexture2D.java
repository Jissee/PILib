...
public class SingleTexture2D implements Texture2D{
    ...
    public SingleTexture2D(ResourceLocation front, RenderSetting renderSetting){
        this(front,null, renderSetting);
    }
    public SingleTexture2D(ResourceLocation front,ResourceLocation back, RenderSetting renderSetting){
        this.front = front;
        this.back = back;
    ...
    public TextureControlCode getStatusCode() {
        return TextureControlCode.START_OR_RESET;
    }
